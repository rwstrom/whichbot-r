...
inline void
GetPot::set(const char* VarName, const double& Value,[[maybe_unused]] const bool Requested /* = yes */)
{ __set_variable(VarName, __double2string(Value).c_str()); }

inline void 
GetPot::set(const char* VarName, const int Value,[[maybe_unused]] const bool Requested /* = yes */)
